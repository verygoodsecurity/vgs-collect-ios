#
#  Be sure to run `pod spec lint VGSFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/verygoodsecurity/vgs-collect-ios", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "framework/VGSFramework", "framework/VGSFramework/**/*.{swift}"
  ...
  # spec.resources = "framework/*.plist"
  ...
  spec.frameworks = "SnapKit", "Alamofire"
