...
internal class ExpDateFormatConvertor: TextFormatConvertor {
    ...
    func convert(_ input: String, inputFormat: InputConvertableFormat, outputFormat: OutputConvertableFormat) -> String {
        /// Make sure the input and output formats are references to `VGSCardExpDateFormat`
        guard let inputFormat = inputFormat as? VGSCardExpDateFormat,
              let outputFormat = outputFormat as? VGSCardExpDateFormat else {
