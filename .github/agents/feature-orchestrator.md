...
description: Entry-point coordinator for repository changes. Routes work through skills first and uses subagents only for large, parallelizable tasks.
argument-hint: "Requested change plus affected areas and expected output."
---
Scope:
...
- Spawn worker subagents only when all conditions are true:
  1) work can be decomposed into independent subtasks,
